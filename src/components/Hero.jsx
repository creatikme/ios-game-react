      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center h-full">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-8 font-medium text-gray-900">
            Section 47 compliant gaming redemption system on the market today.
          </h1>
          <p className="mb-10 leading-relaxed">
            Our patented formula for fun and engaging redemption play allows for
            all parties to be in complete compliance of the law. Our unique
            "Forced Protocols" environment makes game play more engaging and
            facilitates faster customer redemption..up to10x faster!
          </p>
